...
// Cette classe contient les méthodes permettant au robot de suivre le circuit définit dans la classe Etat
...
public class FollowPath extends Thread {
	...
	// Entier correspondant au nombre de fois que le robot doit réessayer de toucher le palet,
	// lorsqu'après avoir détecté le palet et s'être dirigé vers lui il ne l'a pas touché
	...
	// Cette méthode permet de se diriger vers le point suivant du circuit
	...
	// Le robot se repositionne en reculant dans le cas où il n'aurait pas touché le palet
	...
	// Le robot passe au point suivant dans le cas où il n'aurait pas trouvé de palet au point actuel
	...
	// Une fois lancée, le robot suit le circuit en respectant toutes les conditions décrites
	public void run() {
		boolean b =true;
		while(true) {
