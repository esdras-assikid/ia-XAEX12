...
public class Agent {
	...
	private void seRepositionner (){
		...
		/* S'il se retrouve face à un mur
		 * u.detectWall();
		 */
		
		/* S'il se retrouve face au robot adverse
		 * u.facingRobot();
		 */

		/*
		 * Après avoir marqué un point
		 * this.marquerPremierPoint();
		 * this.marquerUnPoint();
		 */
		...
		/*
		 * S'il se retrouve dans son propre camp
		 */
